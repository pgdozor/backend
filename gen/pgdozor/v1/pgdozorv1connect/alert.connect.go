...
const (
	...
	AlertServiceName = "pgdozor.v1.AlertService"
)
...
const (
	...
	// RPC.
	AlertServiceQueryAlertsProcedure = "/pgdozor.v1.AlertService/QueryAlerts"
	// AlertServiceUpdateAlertSettingsProcedure is the fully-qualified name of the AlertService's
	// UpdateAlertSettings RPC.
	AlertServiceUpdateAlertSettingsProcedure = "/pgdozor.v1.AlertService/UpdateAlertSettings"
)

// AlertServiceClient is a client for the pgdozor.v1.AlertService service.
...
// NewAlertServiceClient constructs a client for the pgdozor.v1.AlertService service. By default, it
...
func NewAlertServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) AlertServiceClient {
	...
	alertServiceMethods := v1.File_pgdozor_v1_alert_proto.Services().ByName("AlertService").Methods()
...
// QueryAlerts calls pgdozor.v1.AlertService.QueryAlerts.
...
// UpdateAlertSettings calls pgdozor.v1.AlertService.UpdateAlertSettings.
...
// AlertServiceHandler is an implementation of the pgdozor.v1.AlertService service.
...
func NewAlertServiceHandler(svc AlertServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/pgdozor.v1.AlertService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedAlertServiceHandler) QueryAlerts(context.Context, *connect.Request[v1.QueryAlertsRequest]) (*connect.Response[v1.QueryAlertsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("pgdozor.v1.AlertService.QueryAlerts is not implemented"))
}
...
func (UnimplementedAlertServiceHandler) UpdateAlertSettings(context.Context, *connect.Request[v1.UpdateAlertSettingsRequest]) (*connect.Response[v1.UpdateAlertSettingsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("pgdozor.v1.AlertService.UpdateAlertSettings is not implemented"))
}
